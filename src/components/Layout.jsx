...
const navigation = [
  {
    ...
    links: [
      ...
      { title: 'View All Feature', href: '/docs/AllFeature' },
      { title: 'MainFeature', href: '/docs/MainFeature' },
      { title: 'TeamFeature', href: '/docs/TeamFeature' },
      { title: 'SpamFeature', href: '/docs/SpamFeature' },
      { title: 'StatusFeature', href: '/docs/StatusFeature' },
      { title: 'TcodeFeature', href: '/docs/TcodeFeature' },
      { title: 'EmoteFeature', href: '/docs/EmoteFeature' },
    ],
  },
  {
    title: 'Creator',
    links: [
      { title: 'XEoms', href: '/docs/Creator' }
    ],
  }
]
